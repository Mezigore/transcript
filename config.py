...
TRANSCRIPTION = {
    'model': "large-v3-turbo",  # Путь к модели Whisper
    'model_path_mlx': "mlx-community/whisper-large-v3-turbo",  # Путь к модели Whisper
    ...
    'decode_options': {
        'language': 'ru',
        'temperature': (0.0, 0.2, 0.4),  # Детерминированные результаты
        'best_of': 5,  # Уменьшаем для быстродействия
...
DIARIZATION = {
    ...
    'max_speakers': 4,  # Оптимизировано для типичных онлайн-встреч
    'num_speakers': None,
    'diarization_params': {
